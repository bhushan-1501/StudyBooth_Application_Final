...
import 'package:studybooth_application/dashboards/TeacherDashboard/header_widget.dart';
...
String? CheckStartTime(String? value) {
  if (value == "Please select Start time") {
...
String? CheckEndTime(String? value) {
  if (value == "Please select End time") {
    return ("Please select time");
  }
...
class AddGmeet extends StatefulWidget {
  const AddGmeet({Key? key}) : super(key: key);

  @override
  State<AddGmeet> createState() => _AddGmeetState();
}
...
class _AddGmeetState extends State<AddGmeet> {
  ...
  Widget build(BuildContext context) {
    ...
    _starttimecontroller.text = isstart
        ? "${selectedStartTime.hour.toString().padLeft(2, '0')}:${selectedStartTime.minute.toString().padLeft(2, '0')} ${selectedStartTime.period.toString().split('.')[1]}"
        : "Please select Start time";
    _endtimecontroller.text = isend
        ? "${selectedEndTime.hour.toString().padLeft(2, '0')}:${selectedEndTime.minute.toString().padLeft(2, '0')} ${selectedEndTime.period.toString().split('.')[1]}"
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          decoration: ThemeHelper().textInputDecoration(
                              'Select Start time', 'Click here to select time'),
                          readOnly: true,
                        ...
                        TextFormField(
                          decoration: ThemeHelper().textInputDecoration(
                              'Select End Time', 'Click here to select time'),
                          readOnly: true,
                          validator: CheckDate,
                        ...
                        AuthButton(
                          onTap: () {
                            _firestore.collection('Online_Lectures').add({
