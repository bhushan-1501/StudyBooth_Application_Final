...
class T_login extends StatefulWidget {
  const T_login({Key? key}) : super(key: key);

  @override
  _T_loginState createState() => _T_loginState();
}

class _T_loginState extends State<T_login> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (user != null) {
        try {
          ...
          Fluttertoast.showToast(msg: "Entered id is not a Teacher id.");
        }
      }
    }
  }
